...
export default function CreatePropertyPage() {
  const [formData, setFormData] = useState({
    ...
    // Media (now will be handled by file upload)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Format the data according to schema types
      const formattedData = {
        ...formData,
        ...
        images: allImages, // Use the array of image URLs
      ...
      if (res.ok) {
        ...
        setMessage(result.error || 'Failed to create property.');
      }
    } catch (error) {
